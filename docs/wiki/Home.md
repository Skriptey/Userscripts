...
| ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| **[BunkrDL](BunkrDL)**                   | Bulk-download Bunkr albums into size-capped ZIPs, rate-limited; on balbums.st / bunkr-albums.io listings adds sort, infinite scroll and hover previews.                                                                                                                                       | [BunkrDL](BunkrDL) · [FAQ](FAQ)            |
| **[MetaIncDL](MetaIncDL)**               | Instagram / Facebook / Threads: download your own / authorised photos, videos, stories, reels & highlights in max original quality (images never webp), optionally zipped. Captures the logged-in session; conservative throttling. _(Beta — needs in-browser testing.)_                      | [MetaIncDL](MetaIncDL) · [FAQ](FAQ)        |
...
| **[Spotify Enhancer](Spotify-Enhancer)** | Spotify: barcode (UPC) & per-track ISRCs (copy + MagicISRC), label/release info, a Harmony cross-service lookup, and high-res cover-art download. Reuses the player's own token. _(Beta — needs in-browser testing.)_                                                                         | [Spotify Enhancer](Spotify-Enhancer)       |
